...
public class Main {
	...
	public static void main(String args[])
	{
		...
		Employee emp1 = new Employee(1, "Hans ter Aarde", "Arts", Employee.Sex.MAN);
		Employee emp2 = new Employee(2, "Echbert Koens", "LABMAN", Employee.Sex.MAN);
                
		ArrayList<Employee> empList = new ArrayList<Employee>();
		empList.add(emp1);
                taskController.addEmployee(emp1);

		ArrayList<Employee> empList2 = new ArrayList<Employee>();
		empList2.add(emp2);
                taskController.addEmployee(emp2);
                
                ArrayList<LabTask> labList = new ArrayList<LabTask>();
                ArrayList<LabTask> labList2 = new ArrayList<LabTask>();
		
		Location location = new Location("Avans Hogeschool Breda", "Hogeschoollaan", 1, "Breda", "1234TE", "Nederland");
                Location location2 = new Location("Avans Hogeschool Breda", "Lovedijksstraat", 1, "Breda", "2135PA", "Nederland");
		
                taskController.addLocation(location);
                taskController.addLocation(location2);
